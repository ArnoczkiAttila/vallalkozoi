...
<body>
    <?php 
        $sql = "SELECT csapat_id,csapat_nev FROM csapat";
        if ($result = $conn->execute_query($sql)) {
            ...
            foreach ($result as $csapat) {
                ...
                <p><b>Forduló száma: --- fSzám ---, Menet száma: --- mSzám ---</b></p>
                <?
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach ($result2 as $row) {
                                            $osszeg+=$row["elsoSUM"]+$row["masodikSUM"];
                                            ...
                                            <tr><td><? echo $row["termek_nev"]?></td><td>II. o</td><td><? echo $row["masodik"]?></td><td><? echo $row["masodikAR"]?></td><td><? echo $row["masodikSUM"]?></td></tr>
                                            <?php
                                        }
                                    ?>  
                        <tr>
